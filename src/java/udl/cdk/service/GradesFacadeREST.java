...
public class GradesFacadeREST extends AbstractFacade<Grades> {
    ...
    private GradesPK getPrimaryKey(PathSegment pathSegment) {
         ...
         * URI path part is supposed to be in form of 'somePath;id=idValue;studentid=studentidValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        udl.cdk.GradesPK key = new udl.cdk.GradesPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        udl.cdk.GradesPK key = getPrimaryKey(id);
